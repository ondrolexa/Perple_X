...
c                                 molar entropy
      psys(15) = psys(15) + props(15,jd)*props(16,jd) 
c                                 moles of assemblage
      psys(16) = psys(16) + props(16,jd)
...
c                                 get total without fluid
            psys1(1)  = psys1(1) + v 
c                                 molar enthalpy
            psys1(2)  = psys1(2) + props(2,jd)*props(16,jd) 
c                                 molar heat capacity
            psys1(12) = psys1(12) + props(12,jd)*props(16,jd) 
c                                 molar expansivity
            psys1(13) = psys1(13) + props(13,jd)*v 
c                                 molar compressibility
            psys1(14) = psys1(14) + props(14,jd)*v 
c                                 molar entropy
            psys1(15) = psys1(15) + props(15,jd)*props(16,jd) 
c                                 total number of moles of phases
            psys1(16) = psys1(16) + props(16,jd)

            psys1(17) = psys1(17) + props(16,jd)*props(17,jd)
...
c-----------------------------------------------------------------------
      ...
      gee = vnu(id) * (gee + r * t * dlog(act(id)))
...
c                                 than necessary.
         ...
         if (id.eq.idf(3)) then 
            ...
            gee = gee + vnu(id)*r*t*fo2

         else if (id.eq.idf(1)) then 
        
            gee = gee + vnu(id)*r*t*fh2o
