...
!                                 i10 - max number of option values in perplex_option.dat
      parameter (i0=8,i6=2,i7=20,i8=27,i9=200,i10=25)
...
!                                       in adaptive optimization.
      parameter (k0=25,k1=750000,k2=100000,k3=500,k4=23,k5=12)
      parameter (k7=k5+1,k8=k5+2) 
      parameter (k9=30,k10=240,k12=15,k13=i0*k1,k14=18,k15=3,k16=30)
      parameter (k17=5,k18=29*k1)
      parameter (k19=2*k5+6,k21=750000,k20=i0*k21,k22=i0*k19,k23=5)
      parameter (k24=8000)  
...
!                                        for a solution model composition space.
      parameter (msp=8,mst=2,mdim=7,ms1=msp-1)
