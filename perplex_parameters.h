...
!                                 h9  - max number of solutions
      parameter (h4=3,h5=5,h6=500,h8=250,h9=30)
...
c                                 model type
     ...
     *               stable(h9),limit(h9),lorch(h9)
      ...
      double precision xmng, xmxg, xncg, xmno, xmxo, reachg, xmnh, xmxh
      common/ cxt6r /
...
c                                 local solution model variables:
      logical stck, norf, lowrch, sol689
      integer xtyp
      double precision reach
      common/ cxt61 /reach,xtyp,stck,norf,lowrch,sol689
