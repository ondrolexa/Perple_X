...
c----------------------------------------------------------------------
      ...
      write (n,'(/,a,//,a)') 
     *     'Perple_X version 6.9.1, source updated January 7, 2021.',
...
1015  format (/,2x,'Auto-refine options:',//,
     ...
     *        4x,'intermediate_savrpc     ',l1,9x,'[T] F',/,
     *        4x,'intermediate_savdyn     ',l1,9x,'[T] F',/,
